  ...
  const placeholderColor = AppColors.textSecondary || "#6b7280"
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topBar}>
        <Text style={styles.topBarTitle}>Créer une livraison</Text>
        <Text style={styles.topBarSubtitle}>Où et quand dois-tu livrer aujourd'hui ?</Text>
      </View>
      ...
      <KeyboardAvoidingView
        ...
        enabled={false} // Désactiver le comportement automatique
      >
        <ScrollView 
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.footer}>
          <Button title="Créer la livraison" onPress={handleSubmit} fullWidth size="small" />
        </View>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  footer: {
    ...
    paddingHorizontal: 16,
    paddingVertical: 12,
    paddingBottom: 60, // Augmenté de 20 à 60 pour être visible au-dessus du TabBar
    backgroundColor: AppColors.white,
    borderTopWidth: 1,
  ...
  topBar: {
    ...
    paddingBottom: 15, // Réduit de 10 à 15
    paddingHorizontal: 16,
    backgroundColor: AppColors.white,
    borderBottomWidth: 1,
